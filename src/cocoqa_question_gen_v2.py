...
class QuestionGenerator:
    ...
    def whMovement(self, root):
        ...
        if parent.className == 'WHNP':
            ...
            # else:
            #     verb = 'are' if root.answer.className == 'NNS' else 'is'
            #     vpchild = TreeNode('VB', verb, [], 2)
            #     vpnode = TreeNode('VP', '', [vpchild], 2)
            #     root.children[0].children.insert(1, vpchild)
            return True
        else:
            pass
        ...
        def traverse(node, parent):
            ...
            if node.className == 'PP' and \
                ...
                if c.className == 'NN'and \
                    self.lookupLexname(c.text) == 'noun.artifact':
                    found[0] = True
                    answer[0] = c.text 
        ...
        def traverse(node, parent):
            ...
            if node.className == 'NP' and not ccNoun:
                    ...
                    if child.className == 'NN' or child.className == 'NNS':
                        ...
                        if lexname is not None:
                            ...
                            if (lexname == 'noun.animal' or \
                                ...
                                not child.text.startswith('past')):
                                    whword = 'what'
                ...
                if replace != None:
                    ...
                    for child in node.children:
                        lexname = self.lookupLexname(child.text)
                        if child != replace and (lexname != 'noun.act' or child.className != 'NN'):
