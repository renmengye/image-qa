...
python imageqa_adhoc.py -daquar -m $D_CNN_LSTM_MODEL,$D_BLIND_LSTM_MODEL -n 2-CNN-LSTM,BLIND-LSTM -k 3 -d ../data/daquar-37 -o ../selection -p daquar_img -i ../daquar_adhoc_list.txt -f cocoqa_adhoc.tex
