...
python imageqa_adhoc.py -m $C_CNN_LSTM_MODEL,$C_CNN_BOW_MODEL,$C_BLIND_LSTM_MODEL,$C_BLIND_BOW_MODEL -n 2-CNN-LSTM,CNN-BOW,BLIND-LSTM,BLIND-BOW -k 3 -d ../data/cocoqa-full -o ../selection -p cocoqa_img -i ../cocoqa_adhoc_list.txt -f cocoqa_adhoc
python imageqa_adhoc.py -daquar -m $D_CNN_LSTM_MODEL,$D_BLIND_LSTM_MODEL -n 2-CNN-LSTM,BLIND-LSTM -k 3 -d ../data/daquar-37 -o ../selection -p daquar_img -i ../daquar_adhoc_list.txt -f daquar_adhoc
python imageqa_adhoc.py -m $C_CNN_LSTM_MODEL,$C_CNN_BOW_MODEL,$C_BLIND_LSTM_MODEL,$C_BLIND_BOW_MODEL -n 2-CNN-LSTM,CNN-BOW,BLIND-LSTM,BLIND-BOW -k 3 -d ../data/cocoqa-full -o ../selection -p cocoqa_img -i ../cocoqa_adhoc_list2.txt -f cocoqa_adhoc2
python imageqa_adhoc.py -daquar -m $D_CNN_LSTM_MODEL,$D_BLIND_LSTM_MODEL -n 2-CNN-LSTM,BLIND-LSTM -k 3 -d ../data/daquar-37 -o ../selection -p daquar_img -i ../daquar_adhoc_list2.txt -f daquar_adhoc2
