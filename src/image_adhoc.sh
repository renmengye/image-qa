...
python imageqa_adhoc.py -m $C_CNN_LSTM_MODEL,$C_CNN_BOW_MODEL,$C_BLIND_LSTM_MODEL,$C_BLIND_BOW_MODEL -n 2-CNN-LSTM,CNN-BOW,BLIND-LSTM,BLIND-BOW -k 3 -d ../data/cocoqa-full -o ../selection -p cocoqa_img -i ../cocoqa_adhoc_list.txt -f cocoqa_object_sel.tex
