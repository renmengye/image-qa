...
python daquar_prep.py -object -output $OBJECT_FOLDER -len 52
./build_word_embed.sh $OBJECT_FOLDER
python daquar_prep.py -number -output $NUMBER_FOLDER -len 52
./build_word_embed.sh $NUMBER_FOLDER
python daquar_prep.py -color -output $COLOR_FOLDER -len 52
