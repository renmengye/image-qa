...
def prepare_data(caps, features, worddict, maxlen=None, n_words=10000, zero_pad=False):
    ...
    ans = numpy.round(r.uniform(0,n_ans, (n_samples))).astype('int64')
    return x, x_mask, y, ans

def load_data(load_train=True, load_val=True, load_test=True, path='/ais/gobi3/u/rkiros/flickr8k/align/'):
    ''' Loads the dataset
