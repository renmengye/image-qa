...
# Use this if you are using the CPU
...
#-----------------------------------------------------------------------------#
path_to_models = '/u/rkiros/research/ssg/checkpoints/'
path_to_tables = '/ais/gobi3/u/rkiros/ssg/tables/'
#-----------------------------------------------------------------------------#

path_to_umodel = path_to_models + 'ssgbook_d1000_small_may12.npz'
path_to_bmodel = path_to_models + 'bissgbook_d1200_small_may12.npz'
...
def build_encoder_bi(tparams, options):
    ...
    ctx = tensor.concatenate([proj[0], projr[0][::-1]], axis=proj[0].ndim-1)[0]
